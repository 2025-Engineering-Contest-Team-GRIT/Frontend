...
export const useUI = () => {
  ...
  return {
    ...
    setScreen: useCallback((screen: 'login' | 'app' | 'publicProfile') => setScreen(screen), [setScreen]),
    setSelectedCourseId: useCallback((courseId: string | null) => setSelectedCourseId(courseId), [setSelectedCourseId]),
...
export const useCourse = () => {
  ...
  return {
    selectedCourseForModal,
    aiRecommendation,
    setSelectedCourseForModal: useCallback((course: Course | null) => setSelectedCourseForModal(course), [setSelectedCourseForModal]),
    setAiRecommendation: useCallback((recommendation: string) => setAiRecommendation(recommendation), [setAiRecommendation]),
  };
};
...
export const useNavigation = () => {
  ...
  return {
    ...
    navigateToScreen: useCallback((screen: 'login' | 'app' | 'publicProfile') => setScreen(screen), [setScreen]),
...
export const useCourseSelection = () => {
  ...
  return {
    ...
    openCourseModal: useCallback((course: Course) => {
...
export const useLoadingState = () => {
  ...
  return {
    ...
    withLoading: useCallback(async (asyncFn: () => Promise<void>) => {
      setIsAiLoading(true);
      try {
        await asyncFn();
      } finally {
