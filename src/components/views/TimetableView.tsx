  ...
  return (
    <div className={`p-6 h-full flex flex-col ${fadeIn}`}>
      ...
      <div className="flex justify-between items-start">
        ...
        {onRefresh && <RefreshButton onRefresh={handleRefresh} text="시간표 새로고침" />}
      </div>
        ...
        {timeTable && timeTable.length ? (
            ...
            {timeTable.map((slot, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-xs ${colors.subText} mt-1`}>{slot.classroom}</p>
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <p className="text-slate-500 mb-4">아직 이번 학기 시간표를 설정하지 않았어요.</p>
              <Button
                onClick={() =>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          ...
          <Card className="p-4 text-center">
            ...
            <p className="text-2xl font-bold text-purple-600">
              {new Set(timeTable.map((slot) => slot.day)).size}일
            </p>
          </Card>
        </div>
      )}
